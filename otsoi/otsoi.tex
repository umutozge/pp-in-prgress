...
\subsection{``Partitive'' specificity} %chungladusaw still cite enc for specificity.
\label{scpartspec}
...
critical explanatory weakness of \ctnms{enc91} account and then modify
...
\cttx{farkas02a,heusinger11} for clarification). For this
reason, I will call the notion of ``specificty'' advocated by
\ctnm{enc91} \encspec{ity}, from here on. Here is one of her examples
